...
def compute_frenet_serret(r):
    ...
    B = T.cross(N)
    kappa=T_prime.norm()/r_prime.norm()
...
#print("""
#Comments for Curve 1 (r1) at t = 0:
#- The tangent vector (T1_at_0) indicates the direction in which the curve is moving at t = 0.
#- The normal vector (N1_at_0) shows the direction of the curve's bending at t = 0.
#- The binormal vector (B1_at_0) is perpendicular to both the tangent and normal vectors, giving us the orientation of the curve in space.
#- The curvature (kappa1_at_0) tells us how sharply the curve bends at t = 0. A larger curvature value means a sharper bend.
#- The torsion (tau1_at_0) is non-zero, indicating that the curve is twisting as it moves, and it shows the rate of change of the binormal vector.
#""")
